...
const CCFormContainer = list({
  access: ModuleOpAccessArgs,
  fields: {
    ...commonFormContainerFields('ProviderCreditCard', 'ccFormContainer', 'ccFormContainers'),
    ...TIMESTAMP_SCHEMA,
  },
  ui: {
    listView: {
    ...
    labelField: 'label',
    ...getModuleUIArgs(LIST_ACCESS_KEY_MAP.CCFormContainer),
  },
  hooks: {
