...
export function Cards({
  ...
  const currentIdsArrayWithFetchedItems = [...value.currentIds]
    ...
    .sort((a, b) => {
      return a.itemGetter.data?.sectionOrder - b.itemGetter.data?.sectionOrder
    })
  return (
    <Stack gap="medium">
      ...
      {forceValidation && (
        <Text color="red600" size="small">
          You must finish creating and editing any related {foreignList.label.toLowerCase()} before saving the{' '}
